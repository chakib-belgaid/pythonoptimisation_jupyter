...
docker-machine ssh $name docker run --privileged --name smartwatts-sensor -td -v /sys:/sys -v /var/lib/docker/containers:/var/lib/docker/containers:ro gfieni/powerapi:sensor -n $name -U "mongodb://172.16.45.8:27017" -D "rapls" -C "sensor$name" \
